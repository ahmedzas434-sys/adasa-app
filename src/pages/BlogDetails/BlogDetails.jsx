...
export default function BlogDetails() {
  ...
  const filterCard = posts.filter((element) => {
    return element.category === category && element.id !== Number(id);
  });
  ...
  return (
    <React.Fragment>
      <section className="min-h-screen">
        <div
          className="relative min-h-125 bg-cover bg-center bg-no-repeat px-3 pt-32 pb-10 md:px-4 xl:px-[10%]"
          style={{
            backgroundImage: `linear-gradient(to bottom, transparent, rgba(0,0,0,1)), url(${image})`,
          }}
        >
          <div className="absolute right-4 inline-flex items-center gap-2 rounded-full border border-white/10 bg-black/30 px-4 py-2 text-sm backdrop-blur-md">
            <Link to="/">
              <FontAwesomeIcon
                icon={faHouse}
            ...
            <FontAwesomeIcon icon={faAngleLeft} className="text-white/30" />
            <Link
              to="/blog"
              className="text-white/70 transition-colors hover:text-white"
            >
          ...
          <div className="space-y-6 pt-22 max-md:md:ps-0 xl:mt-10 xl:p-12">
            ...
            <h2 className="max-w-250 text-[30px] leading-9.5 font-bold text-white md:text-5xl md:leading-15 lg:text-6xl lg:leading-18.75">
              {title}
            </h2>
        ...
        <div className="bg-neutral-950 px-3 py-12 md:px-4 xl:px-[10%]">
          <div className="flex items-start gap-10 max-lg:flex-col-reverse xl:container xl:mx-auto">
            <div className="w-1/1 lg:w-3/4">
              <p className="mb-10 rounded-2xl border border-orange-500/20 bg-linear-to-r from-orange-500/10 to-yellow-500/5 p-6 text-lg leading-7.25 text-neutral-200 italic">
                {`"${excerpt}"`}
              </p>
              ...
              <div className="*:py-[56px_24px]">
                {qa.map(({ answer, question }, index) => {
                  const newId = `art${index + 1}`;
                  return (
                    <div id={newId} className="space-y-6">
                      <h3 className="flex items-center gap-3 text-3xl font-bold text-white">
                        <div className="flex size-10 items-center justify-center rounded-xl border border-orange-500/30 bg-orange-500/10 text-3xl text-orange-500">
              ...
              <div className="mt-14 space-y-6">
                <div className="space-y-5 rounded-2xl border border-[#262626] bg-[#111111] p-6">
                  <div className="flex items-center gap-3">
                    <div className="centerByFlex size-10 rounded-xl border border-orange-500/30 bg-orange-500/10 text-orange-500">
                  ...
                  <div className="flex items-center gap-2">
                    {tags.map((el) => {
                      return (
                        <span className="cursor-pointer rounded-full border border-neutral-800 bg-[#1a1a1a] px-4 py-2 text-sm text-neutral-400 transition-colors hover:border-orange-500/50 hover:text-orange-500">
                          #{el}
                        </span>
                      );
                    })}
                ...
                <div className="flex items-center justify-between rounded-2xl border border-[#262626] bg-[#111111] p-6">
                  <div className="flex items-center gap-3">
                    <div className="centerByFlex size-10 rounded-xl border border-orange-500/30 bg-orange-500/10 text-orange-500">
                ...
                <div className="flex gap-5 rounded-2xl border border-[#262626] bg-[#111111] p-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm leading-5.75 text-neutral-400">
            ...
            <div className="w-1/1 space-y-6 lg:sticky lg:top-25 lg:w-1/4">
              <div className="space-y-5 rounded-2xl border border-[#262626] bg-[#111111] p-6">
                <h3 className="flex items-center gap-3 text-[16px] font-bold text-white">
                  <div className="flex size-10 items-center justify-center rounded-xl border border-orange-500/30 bg-orange-500/10 text-lg text-orange-500">
              ...
              <div className="grid-col-1 grid gap-4 rounded-2xl border border-[#262626] bg-[#111111] p-6 text-center md:grid-cols-2">
                <div className="rounded-xl bg-[#0a0a0a] p-2 xl:p-3">
                  <FontAwesomeIcon className="text-orange-500" icon={faClock} />
                  <h5 className="text-[15px] leading-5.5 font-bold text-white">
                    {readTime}
                  </h5>
              ...
              <div className="space-y-4 rounded-2xl border border-orange-500/20 bg-linear-to-br from-orange-500/10 to-yellow-500/5 p-6 text-center">
                <div className="centerByFlex mx-auto mb-5 size-14 rounded-2xl bg-orange-500/20">
                  <FontAwesomeIcon
                    className="text-xl text-orange-500"
                    icon={faEnvelope}
                  />
                </div>
                <h5 className="font-bold text-white">لا تفوّت جديدنا</h5>
                <p className="text-sm text-neutral-400">
                  اشترك للحصول على أحدث المقالات
                </p>
                <Link
                  to="/blog"
                  className="block w-full rounded-xl bg-orange-500 py-3 font-semibold text-white transition-colors hover:bg-orange-600"
                >
                  تصفح المزيد
                </Link>
              </div>
          ...
          <div className="mt-20 space-y-10 border border-transparent border-t-neutral-800 pt-12">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                <div className="flex h-12 w-12 items-center justify-center rounded-2xl border border-orange-500/30 bg-orange-500/10 text-xl text-orange-500">
              ...
              <Link
                to="/blog"
                className="group hidden items-center gap-1.5 text-orange-500 transition-colors hover:text-orange-400 sm:flex"
              >
                عرض الكل
                <FontAwesomeIcon
                  icon={faArrowLeft}
                  className="baseTransition group-hover:-translate-x-1.5"
                />
              </Link>
            </div>
