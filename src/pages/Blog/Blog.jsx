...
import ButtonInIcon from "../../components/ButtonInIcon/ButtonInIcon";
import Card from "../../components/Card/Card";
import ButtonFooter from "../../components/ButtonFooter/ButtonFooter";
import ButtonSlid from "../../components/ButtonSlid/ButtonSlid";
...
export default function Blog() {
  ...
  const [activeButton, setActiveButton] = useState(map[category] || 1);
  function editeActiveButton(id, buttonName) {
    setActiveButton(id);
    let res = posts.filter((post) => post.category === buttonName);
    setCounter(res.length || posts.length);
    setNameCategory(buttonName);
    editPage(1);
  }
  ...
  function editeIsSelectedCategory() {
    setIsSelectedCategory(!isSelectedCategory);
    editeActiveButton(1, "جميع المقالات");
    setSearch(() => {
  ...
  // * ******************** Start Functions ***********************
  function pageNextPrev(page, dir) {
    if (dir === "left") {
      if (page < Math.ceil(counter / 6)) {
        setPage(page + 1);
        scroolToTop();
      }
    } else if (dir === "right") {
  ...
  function displayButtonPage() {
    const number = Math.ceil(counter / 6);
    let res = [];

    for (let i = 1; i <= number; i++) {
      res.push(
        <ButtonFooter key={i} func={editPage} choose={page} value={i} />,
      );
    }
  ...
  return (
    <Fragment>
      <section className="overflow-hidden bg-neutral-950 pt-[81.6px] md:pt-[85.6px]">
        <div className="centerByFlex relative py-20">
          ...
          <Article
            ...
            hText="استكشف"
            spanText="مقالاتنا"
            pText="اكتشف الدروس والرؤى وأفضل الممارسات للتطوير الحديث"
          />
        </div>

        <div className="sticky top-21 z-999999 border border-transparent border-b-neutral-800 bg-neutral-950 px-3 md:px-4 xl:px-[10%]">
          <div className="flex items-center justify-between gap-4 py-4 max-md:flex-col xl:container xl:mx-auto">
            <div className="relative w-80 max-md:w-full">
              <input
                  ...
                  setCounter(
                    posts.filter((element) => {
                      return (
                        ...
                        element.excerpt.includes(value) ||
                ...
                value={search}
                className="w-full rounded-xl border border-neutral-800 bg-neutral-900 p-[12px_48px_12px_30px] text-white outline-none placeholder:text-neutral-400 focus:border-orange-500 focus:[box-shadow:0_0_0_3px_#f973161a]"
                type="text"
                placeholder="أبحث في المقلات..."
              />
              <FontAwesomeIcon
                icon={faMagnifyingGlass}
                className="absolute top-1/2 left-5 -translate-1/2 text-neutral-500"
              />
            </div>

            <div className="centerByFlex flex-wrap gap-1">
              <Button
                id={1}
                activeButton={activeButton}
                func={editeActiveButton}

                buttonName="جميع المقالات"
              />
              <Button
                id={2}
                activeButton={activeButton}
        ...
        <div className="px-3 md:px-4 xl:px-[10%]">
          <div className="xl:container xl:mx-auto">
            <div className="space-y-10 py-12">
              <div className="flex items-center justify-between">
                <div className="text-neutral-400">
                  عرض <span className="font-bold text-white">{counter}</span>{" "}
                  مقالات
                  {nameCategory !== "جميع المقالات" && (
                ...
                <div className="flex items-center gap-3">
                  ...
                  {(nameCategory !== "جميع المقالات" || search !== "") && (
                    <button
                      onClick={editeIsSelectedCategory}
                      className="baseTransition flex cursor-pointer items-center gap-1 border-none text-sm text-neutral-500 hover:text-orange-500"
                    >
              ...
              <div
                className={`grid grid-cols-1 gap-8 ${gridMenu === 1 ? "md:grid-cols-2 lg:grid-cols-3" : ""}`}
              >
                {nameCategory === "جميع المقالات" &&
                  search === "" &&
                  gridMenu === 1 &&
                ...
                {nameCategory !== "جميع المقالات" &&
                  ...
                  posts
                    .filter((element) => {
                      return element.category === nameCategory;
                    })
                    .map((element) => {
                      return <Card key={element.id} element={element} />;
                    })
                ...
                {nameCategory === "جميع المقالات" &&
                  ...
                  posts
                    .map((element) => {
                      return <CardMenu key={element.id} element={element} />;
                    })
                    .slice((page - 1) * 6, page * 6)}
                  ...
                  posts
                    .filter((element) => {
                      return (
                        ...
                        element.excerpt.includes(search) ||
                    ...
                    .map((element) => {
                      return gridMenu === 1 ? (
                        ...
                        <CardMenu key={element.id} element={element} />
                      );
                    })
                    .slice((page - 1) * 6, page * 6)}
              </div>
              ...
              {nameCategory === "جميع المقالات" && (
                <div className="flex flex-col items-center gap-3">
                  <div className="centerByFlex gap-2">
                    <ButtonSlid
                      func={pageNextPrev}
                      dir="right"
                      page={page}
                      value={faChevronRight}
                      max={Math.ceil(counter / 6)}
                    />
                  ...
                  <span className="text-sm text-neutral-500">
                    صفحة {page} من {Math.ceil(counter / 6)}
                  </span>
                </div>
              )}

              {nameCategory !== "جميع المقالات" && counter > 6 && (
                <div className="flex flex-col items-center gap-3">
                  <div className="centerByFlex gap-2">
                    <ButtonSlid
                      func={pageNextPrev}
